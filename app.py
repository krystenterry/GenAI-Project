...
# Page config
st.set_page_config(page_title="AI Study Guide Creator", page_icon="🎯")

# UI
st.title("🎯 AI Study Guide Creator")
st.subheader("Generate Comprehensive Study Guides with Complete Exam Concepts for Any Topic")

# Inputs
topic = st.text_input(
    "Enter Topic (Example: Scrum Master, World War II Supply Chain, PMP):"
)
